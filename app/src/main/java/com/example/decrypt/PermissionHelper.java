...
public class PermissionHelper {
    ...
    public void requestPermission(final RequestResultListener listener, final String... permissions){
        ...
        if(newPermissions.length==0){
            ...
            RxPermissions.getInstance(AppContext.getContext())
                    ...
                    .subscribe(new Action1<Boolean>() {
                        ...
                        public void call(Boolean granted) {
                            ...
                            if (!granted) {
                            Toast.makeText(AppContext.getContext(),getTips(permissions),Toast.LENGTH_LONG).show();
                            }
                        }
                    });
        }
    ...
    public String[] checkPermissions(String... permissions){
        ...
        for(String permission:permissions){
            if(PackageManager.PERMISSION_GRANTED != pm.checkPermission(permission,AppContext.getContext().getPackageName())){
                pers.add(permission);
            }
        }
